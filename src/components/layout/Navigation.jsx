    ...
    <div className="ml-10 flex items-center space-x-6">
      {navItems.map(item => (
        ...
        >
          {item.name}
          <span 
            className={`absolute bottom-0 left-0 w-full h-0.5 bg-gradient-to-r ${darkMode ? 'from-violet-500 to-fuchsia-500' : 'from-emerald-500 to-teal-500'} rounded-full transform ${
