...
const Hero = () => {
  ...
  return (
    <section id="home" className="pt-28 pb-16 md:pt-36 md:pb-24 relative" aria-labelledby="hero-title">
      {/* Background elements */}
      <div 
        className={`absolute top-0 right-0 -z-10 w-1/3 aspect-square rounded-full bg-gradient-to-br ${
          darkMode ? 'from-violet-500/10 to-fuchsia-500/10' : 'from-emerald-500/10 to-teal-500/10'
        } blur-3xl animate-pulse-slow`}
      ></div>
      <div 
        className={`absolute bottom-0 left-0 -z-10 w-1/2 aspect-square rounded-full bg-gradient-to-tr ${
          darkMode ? 'from-cyan-500/10 to-blue-500/10' : 'from-amber-500/10 to-orange-500/10'
        ...
        <div className="grid md:grid-cols-2 gap-12 items-center">
          <ScrollReveal animation="fade-right" delay={200}>
            <div className={`inline-flex items-center px-4 py-2 rounded-full text-sm font-medium ${
              darkMode ? 'bg-violet-500/10 border border-violet-500/20 text-violet-400' : 'bg-teal-500/10 border border-teal-500/20 text-teal-600'
            } mb-6`}>
            ...
            <h1 id="hero-title" className="text-4xl md:text-5xl lg:text-6xl font-bold leading-tight tracking-tight mb-6">
              ...
              <span className={`text-transparent bg-clip-text bg-gradient-to-r ${
                darkMode ? 'from-cyan-500 to-blue-500' : 'from-amber-500 to-orange-500'
              }`}>Web Developer</span>
            </h1>
            
            <p className={`text-lg ${darkMode ? 'text-gray-300' : 'text-gray-600'} leading-relaxed max-w-xl mb-8`}>
            ...
            <div className="flex flex-wrap gap-4">
              ...
              <a 
                href="#contact"
                className={`border ${
                  darkMode ? 'border-violet-500 text-violet-400 hover:bg-violet-500/10' : 'border-teal-600 text-teal-600 hover:bg-teal-500/10'
          ...
          <ScrollReveal animation="fade-left" delay={400}>
            <div className="relative">
              {/* Main profile image */}
              <div className={`aspect-square rounded-2xl overflow-hidden border-8 ${
              ...
              <div className={`absolute z-20 -top-6 -left-2 md:-left-6 p-4 rounded-lg ${
                ...
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  darkMode ? 'bg-violet-500/20 text-violet-400' : 'bg-teal-500/20 text-teal-600'
                }`}>
                ...
                <div>
                  ...
                  <div className={`text-xs ${darkMode ? 'text-gray-400' : 'text-gray-500'}`}>2+ Years</div>
                </div>
              </div>
              ...
              <div className={`absolute z-20 top-1/4 -right-2 xl:-right-10 p-4 rounded-lg ${
                ...
                <div className="text-sm text-center font-medium">Projects</div>
              </div>
              
              <div className={`absolute z-20 -bottom-6 right-10 p-4 rounded-lg ${
                darkMode ? 'bg-gray-800' : 'bg-white'
              } shadow-lg flex items-center gap-2 animate-float animation-delay-2000`}>
                <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                  darkMode ? 'bg-cyan-500/20 text-cyan-400' : 'bg-amber-500/20 text-amber-600'
                }`}>
                  <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
